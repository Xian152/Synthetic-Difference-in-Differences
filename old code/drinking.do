...
replace group6 = 2 if inlist(year, 2018) & treated2017 ==0
	...
	table1 , by(group1) vars(drinking12 contn\ drinking30  contn\  sex contn\ gdp_pc contn\ prop_60 contn\ prop_65 contn\  ) format(%2.1f) one mis saving("/Volumes/alan/method paper/Data Analysis/DS1_treat_rawgroup1.xls", replace) 
	table1, by(group2) vars(drinking12 contn\ drinking30  contn\   sex contn\  gdp_pc contn\ prop_60 contn\ prop_65 contn\  ) format(%2.1f) one mis saving("/Volumes/alan/method paper/Data Analysis/DS1_treat_rawgroup2.xls", replace) 

	table1, by(group3) vars(drinking12 contn\ drinking30  contn\  sex contn\ gdp_pc contn\ prop_60 contn\ prop_65 contn\  ) format(%2.1f) one mis saving("/Volumes/alan/method paper/Data Analysis/DS1_treat_rawgroup3.xls", replace) 
	table1, by(group4) vars(drinking12 contn\ drinking30  contn\  sex contn\ gdp_pc contn\ prop_60 contn\ prop_65 contn\  ) format(%2.1f) one mis saving("/Volumes/alan/method paper/Data Analysis/DS1_treat_rawgroup4.xls", replace) 

	table1, by(group5) vars(drinking12 contn\ drinking30  contn\   sex contn\ gdp_pc contn\ prop_60 contn\ prop_65 contn\  ) format(%2.1f) one mis saving("/Volumes/alan/method paper/Data Analysis/DS1_treat_rawgroup5.xls", replace) 
	table1, by(group6) vars(drinking12 contn\ drinking30  contn\   overweight  contn\  obesity  contn\ sex contn\ gdp_pc contn\ prop_60 contn\ prop_65 contn\  ) format(%2.1f) one mis saving("/Volumes/alan/method paper/Data Analysis/DS1_treat_rawgroup6.xls", replace) 

****************************************************************************
***************************************************************	 
********************* 描述性	抽样 ****************
***************************************************************	 
use "/Volumes/alan/SDID_CDC/Output/final with 18 random select untreated.dta",clear
...
*/
	table1 , by(group1) vars(drinking30 contn\ drinking12  contn\  sex contn\ gdp_pc contn\ prop_60 contn\ prop_65 contn\  ) format(%2.1f) one mis saving("/Volumes/alan/method paper/Data Analysis/Select_DS1_treat_rawgroup1.xls", replace) 
	table1, by(group2) vars(drinking30 contn\ drinking12  contn\  sex contn\  gdp_pc contn\ prop_60 contn\ prop_65 contn\  ) format(%2.1f) one mis saving("/Volumes/alan/method paper/Data Analysis/Select_DS1_treat_rawgroup2.xls", replace) 

	table1, by(group3) vars(drinking30 contn\ drinking12  contn\    sex contn\ gdp_pc contn\ prop_60 contn\ prop_65 contn\  ) format(%2.1f) one mis saving("/Volumes/alan/method paper/Data Analysis/Select_DS1_treat_rawgroup3.xls", replace) 
	table1, by(group4) vars(drinking30 contn\ drinking12  contn\  sex contn\ gdp_pc contn\ prop_60 contn\ prop_65 contn\  ) format(%2.1f) one mis saving("/Volumes/alan/method paper/Data Analysis/Select_DS1_treat_rawgroup4.xls", replace) 

	table1, by(group5) vars(drinking30 contn\ drinking12  contn\   sex contn\ gdp_pc contn\ prop_60 contn\ prop_65 contn\  ) format(%2.1f) one mis saving("/Volumes/alan/method paper/Data Analysis/Select_DS1_treat_rawgroup5.xls", replace) 
	table1, by(group6) vars(drinking30 contn\ drinking12  contn\   sex contn\ gdp_pc contn\ prop_60 contn\ prop_65 contn\  ) format(%2.1f) one mis saving("/Volumes/alan/method paper/Data Analysis/Select_DS1_treat_rawgroup6.xls", replace) 
/*
	table1, by(group7) vars(drinking30 contn\ drinking12  contn\   sex contn\ gdp_pc contn\ prop_60 contn\ prop_65 contn\  ) format(%2.1f) one mis saving("/Volumes/alan/method paper/Data Analysis/Select_DS1_treat_rawgroup7.xls", replace) 
	table1, by(group8) vars(drinking30 contn\ drinking12  contn\   sex contn\ gdp_pc contn\ prop_60 contn\ prop_65 contn\  ) format(%2.1f) one mis saving("/Volumes/alan/method paper/Data Analysis/Select_DS1_treat_rawgroup8.xls", replace) 
*/
**#
***************************************************************	 
********************* DID	 ****************
...
set scheme cleanplots, perm
	...
	*gen av_dk2 = av_dk if treated_g == 0
	...
	twoway (line av_dk1 av_dk0 year,sort)  , title("Prevalence of Drinking in the past 12 months") legend(ring(0) pos(5)) ytitle("Prevalence of Drinking") xlabel(2006(2)2018)  xtitle("year")
...
use "/Volumes/alan/method paper/Data Analysis/final with 18 random select untreated.dta",clear
ren (treated treated_g) (post treat)
gen post_pre = post[_n+1]

	gen treat_g = treat * post
	
	drop if time_window>=0 
	mlogit post_pre currentsmoking dailysmoking smokingamount quitsmoking shsmoking BMI waist hazarddrinking harmdrinking lowvegfru highredmeat lackphysical usualexercise neverexercise overweight obesity overweightint obesityint centralobesity centralobesityint sbp dbp hypertension awarehypertension treathypertension controlhypertension diabetes awarediabetes treatdiabetes drugdiabetes controldiabetes insurance men edu0 edu1 edu2 edu3 occup0 occup1 occup2 occup3 hba1c fbg bmi,rr
	outreg2 using "/Volumes/alan/method paper/Data Analysis/Select_TWFE.doc",replace word stats(coef ci) dec(3) alpha(0.01,0.05,0.1,0.15) symbol(***,**,*,+) 
	xtreg BMI  eventt* i.year i.dspcode, r fe
	outreg2 using "/Volumes/alan/method paper/Data Analysis/Select_TWFE.doc",append word stats(coef ci) dec(3) alpha(0.01,0.05,0.1,0.15) symbol(***,**,*,+)
...
xtset dspcode year    
	...
	outreg2 using "/Volumes/alan/method paper/Data Analysis/Select_correlation_drinking.doc",replace word stats(coef ci) dec(3) alpha(0.01,0.05,0.1,0.15) symbol(***,**,*,+)
	xtreg drinking12 sex prop_65 log_gdp, r fe
	outreg2 using "/Volumes/alan/method paper/Data Analysis/Select_correlation_drinking.doc",append word stats(coef ci) dec(3) alpha(0.01,0.05,0.1,0.15) symbol(***,**,*,+)	
